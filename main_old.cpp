...
int main()
{
    ...
    cl_mem c_mem_obj = clCreateBuffer(context, CL_MEM_WRITE_ONLY,
            LIST_SIZE * sizeof(int), NULL, &ret);
    cl_mem list_size_mem_obj = clCreateBuffer(context, CL_MEM_READ_ONLY,
    ...
    ret = clEnqueueWriteBuffer(command_queue, list_size_mem_obj, CL_TRUE, 0,
        1 * sizeof(int), &LIST_SIZE, 0, NULL, NULL);
    printf("ret at %d is %d\n", __LINE__, ret);
    ...
    ret = clSetKernelArg(kernel, 3, sizeof(cl_mem), (void *)&list_size_mem_obj);
    printf("ret at %d is %d\n", __LINE__, ret);
